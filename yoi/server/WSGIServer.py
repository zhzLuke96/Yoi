...
class WSGIServer(object):
    ...
    def handle_request(self):
        self.request_data = self.connection.recv(1024).decode()
    ...
    def get_url_parameter(self):
        ...
        self.request_method, self.path, self.request_version = self.request_dict.get(
            'Path').split()
